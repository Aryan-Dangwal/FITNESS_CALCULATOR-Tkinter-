...
B1 = tk.Button(top, text="Generate Report", command=lambda: main(E1.get(), int(E2.get()), int(E3.get()), float(E4.get()), int(E5.get()), int(E6.get()), int(E7.get()), int(E8.get()), int(E9.get()), int(E10.get()), int(E50.get()), int(E51.get())))
